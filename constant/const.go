...
const (
	...
	API_GNB_UE_HANDOVER        = "/ue/handover"
	API_GNB_UE_HANDOVER_METHOD = http.MethodPost
)
...
const (
	...
	API_REQUEST_GNB_UE_HANDOVER        = API_PREFIX_GNB + API_GNB_UE_HANDOVER
	API_REQUEST_GNB_UE_HANDOVER_METHOD = API_GNB_UE_HANDOVER_METHOD
)
